...
function withBeam(nextConfig = {}, beamOptions) {
  ...
  return {
    ...
    webpack: (config2, context) => {
      ...
      if (typeof nextConfig.webpack === "function") {
        return nextConfig.webpack(config2, context);
      }
      return config2;
    }
  };
}
function logTunnelUrl(tunnel) {
  console.log("");
